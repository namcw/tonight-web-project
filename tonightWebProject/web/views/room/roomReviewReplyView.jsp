...
<tr><th>작성자</th>
<td>
<input type="text" name="rwriter" value="<%= member.getMemberId() %>" readonly></td></tr>
<tr><th>내용</th><td><textarea name="rcontent" rows="7" cols="50"></textarea></td></tr>
<tr><th colspan="2">
...
<h4 align="center"><a href="/tonight/rreview?page=<%= currentPage %>">목록</a></h4>
<br>
