...
<form action="/tonight/rrupdate" method="post" enctype="multipart/form-data">
<input type="hidden" name="rnum" value="<%= Review.getReviewNum() %>">
...
<tr><th>제목</th><td><input type="text" name="rtitle" value="<%= Review.getReviewTitle() %>"></td></tr>
<tr><th>작성자</th>
<td><input type="text" readonly name="rwriter" value="<%= Review.getReviewriter() %>"></td></tr>
<tr><th>첨부파일</th>
<td>
...
<tr><th>내용</th><td><textarea cols="50" rows="7" name="rcontent"><%= Review.getReviewContent() %></textarea></td></tr>
...
<% }else{ //댓글일 때 %>
<form action="/tonight/rreplyupdate" method="post">
...
<tr><th>작성자</th>
<td>
<input type="text" name="rwriter" value="<%= Review.getReviewriter() %>" readonly></td></tr>
<tr><th>내용</th><td><textarea name="rcontent" rows="7" cols="50"><%= Review.getReviewContent() %></textarea></td></tr>
<tr><th colspan="2">
