	...
	<% for(Tour tour : list) { %>
	  ...
	  <div class="col-xs-4" style="border-style:outset; border-width:2px">
	    ...
	    <div class="spinner"></div>
	        <div class="img"><img src="/tonight/tuploadfiles/<%=tour.getTourRname() %>"alt="img"></div>
	        <div class="info">
	          <div class="info-back">
	            <h3>여행 패키지 Top 3</h3>
...
<% for(Accommodation accom : list1) { %>
      ...
      <img src="/tonight/auploadfiles/<%=accom.getAccRname() %>" class="img-responsive" style="width:100%" alt="Image">
      </a>
  ...
  <div class="col-sm-4" style="border-style:outset; border-width:2px">
    ...
    <div class="ih-item circle effect10 top_to_bottom"><a href="/tonight/adetail?accomId=<%= accom.getAccId() %>">
        <div class="img"><img src="/tonight/auploadfiles/<%=accom.getAccRname() %>" alt="img"></div>
        <div class="info">
          <h3 >숙소 Top 3</h3>
