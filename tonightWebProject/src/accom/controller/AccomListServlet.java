...
/**
 * Servlet implementation class accomListServlet
 */
@WebServlet("/alist")
public class AccomListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AccomListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//해당 페이지용 목록 조회
		ArrayList<Accommodation> list = aservice.selectList(currentPage, limit);
		...
		if(list != null) {
			...
			request.setAttribute("message", "숙소 리스트 조회 실패!");
			view.forward(request, response);
		}
