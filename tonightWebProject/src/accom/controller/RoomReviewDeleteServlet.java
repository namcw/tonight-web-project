...
/**
 * Servlet implementation class RoomReviewDeleteServlet
 */
@WebServlet("/rrdelete")
public class RoomReviewDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RoomReviewDeleteServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(new RoomReviewService().deleteRoomReview(rnum) > 0){
